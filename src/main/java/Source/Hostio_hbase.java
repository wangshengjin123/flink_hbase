...
public class Hostio_hbase {
    private static TableName tableName = TableName.valueOf("www_hostio");
    ...
    public static void main(String[] args) {
        ...
        FlinkKafkaConsumer011 kafkaConsumer011 = new FlinkKafkaConsumer011("hostio", new SimpleStringSchema(), poro);
...
/*        TimeStamp ts = new TimeStamp(new Date());
        ...
        io_time     =Model1_1.getString("io_time");
        iostat_await=Model1_1.getString("iostat_await");
        iostat_busy =Model1_1.getString("iostat_busy");
        iostat_time =Model1_1.getString("iostat_time");
        disk_name   =Model1_1.getString("disk_name");
        ...
        put.addColumn(org.apache.hadoop.hbase.util.Bytes.toBytes(columnFamily), org.apache.hadoop.hbase.util.Bytes.toBytes("io_time"), org.apache.hadoop.hbase.util.Bytes.toBytes(io_time));
        put.addColumn(org.apache.hadoop.hbase.util.Bytes.toBytes(columnFamily), org.apache.hadoop.hbase.util.Bytes.toBytes("iostat_await"), org.apache.hadoop.hbase.util.Bytes.toBytes(iostat_await));
        put.addColumn(org.apache.hadoop.hbase.util.Bytes.toBytes(columnFamily), org.apache.hadoop.hbase.util.Bytes.toBytes("iostat_busy"), org.apache.hadoop.hbase.util.Bytes.toBytes(iostat_busy));
        put.addColumn(org.apache.hadoop.hbase.util.Bytes.toBytes(columnFamily), org.apache.hadoop.hbase.util.Bytes.toBytes("iostat_time"), org.apache.hadoop.hbase.util.Bytes.toBytes(iostat_time));
        put.addColumn(org.apache.hadoop.hbase.util.Bytes.toBytes(columnFamily), org.apache.hadoop.hbase.util.Bytes.toBytes("disk_name"), org.apache.hadoop.hbase.util.Bytes.toBytes(disk_name));
        t.put(put);
